  ...
  return (
    <div className="p-8">
      <div className="max-w-3xl mx-auto flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3">
            <span
              ...
              style={{
                ...
                animation: isLive ? "sl-pulse 1s ease-in-out infinite" : "none",
              }}
            />
            ...
            <span className="font-consolemono text-console-muted text-xs">Session {sessionClock}</span>
          </div>
          <button
            onClick={endSession}
        ...
        {status && <p className="font-consolemono text-console-muted text-xs tracking-wide uppercase">▸ {status}</p>}
        ...
        <form onSubmit={launchQuestion} className="bg-console-panel border border-console-line rounded-md overflow-hidden">
          <div className="px-5 py-3 border-b border-console-line flex items-center gap-2.5">
            ...
            <span className="font-condensed font-bold text-console-text text-xs tracking-[0.2em] uppercase">CH.1 — Question</span>
          </div>
        ...
        <div className="bg-console-panel border border-console-line rounded-md overflow-hidden">
          ...
          <div className="flex flex-col">
            ...
            {leaderboard.map((row, i) => (
              <div key={row.tiktok_user} className="flex items-center justify-between px-5 py-2.5 border-b border-console-line last:border-b-0">
                <div className="flex items-center gap-3">
                  <span className="font-consolemono text-console-muted text-xs w-5">{String(i + 1).padStart(2, "0")}</span>
